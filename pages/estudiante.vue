      ...
      <table class="min-w-full bg-white border border-gray-200">
        <thead>
          <tr>
            ...
            <th class="px-4 py-2 border-b-2 border-gray-200 bg-blue-200 text-black text-center">Cuarto ID</th>
        ...
        <tbody>
          <tr v-for="estudiante in estudiantes" :key="estudiante.id" class="hover:bg-gray-50">
            ...
            <td class="px-4 py-2 border-b border-gray-200 text-center">
              <img :src="estudiante.foto" alt="Foto del Estudiante" class="max-w-xs rounded-lg shadow-md">
            </td>
            <td class="px-4 py-2 border-b border-gray-200 text-center">
